(function () {
angular
    .module('mainMdl').controller('hdeCtrl', mainCtrl);
	
	mainCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'mainService', 'chartOptionService'];
