(function () {
angular
    .module('mainMdl').controller('ftpsCtrl', ftpsCtrl);
	
ftpsCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'ftpsMainService', 'ftpsChartOptionService'];
    
	function ftpsCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("ftpsCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
