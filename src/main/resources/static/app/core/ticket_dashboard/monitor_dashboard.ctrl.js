(function () {
angular
    .module('mainMdl').controller('ticketCtrl', ticketCtrl);
	
ticketCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'ticketMainService', 'ticketChartOptionService'];
    
	function ticketCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
       ...
       /* function getDonutOptions(duration) {
        ...
        function getData(lastUpdatedData) {
            ...
            ctrl.altc='';
            ctrl.ticketStatus='';
            ctrl.install2GoTickets ='';
            ctrl.thunderheadTickets ='';
            ctrl.sibelSecurityTickets ='';
            ctrl.sibelInfraTickets ='';
            ctrl.hdConnectTickets='';
            ctrl.hsSupportTickets ='';
            ctrl.sibelAppTickets ='';
            ctrl.sibelAppTransferTickets ='';
        	...
        	mainService.getTreeData(lastUpdatedData).then(function(response) {
                ...
                ctrl.install2GoTickets =response.data.responseData.install2GoTickets;
                ctrl.thunderheadTickets =response.data.responseData.thunderheadTickets;
                ctrl.sibelSecurityTickets =response.data.responseData.sibelSecurityTickets;
                ctrl.sibelInfraTickets =response.data.responseData.sibelInfraTickets;
                ctrl.hsSupportTickets =response.data.responseData.hsSupportTickets;
                ctrl.hdConnectTickets= response.data.responseData.hdConnectTickets;
                ctrl.sibelAppTickets =response.data.responseData.sibelAppTickets;
                ctrl.sibelAppTransferTickets =response.data.responseData.sibelAppTransferTickets;
