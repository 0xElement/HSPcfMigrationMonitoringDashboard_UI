(function () {
angular
    .module('mainMdl').controller('ewrCtrl', ewrCtrl);
	
ewrCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'ewrMainService', 'ewrChartOptionService'];
    
	function ewrCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("ewrCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
