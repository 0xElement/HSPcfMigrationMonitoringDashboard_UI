(function () {
angular
    .module('mainMdl').controller('altcCtrl', altcCtrl);
	
altcCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'altcMainService', 'altcChartOptionService'];
    
	function altcCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("altcCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
