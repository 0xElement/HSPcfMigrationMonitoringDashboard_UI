(function () {
angular
    .module('mainMdl').controller('iconxCtrl', mainCtrl);
	
	mainCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'iconxService', 'chartOptionService'];
