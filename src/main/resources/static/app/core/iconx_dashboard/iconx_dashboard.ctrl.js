(function () {
angular
    .module('mainMdl').controller('ICONXCtrl', ICONXCtrl);
	
ICONXCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'ICONXMainService', 'ICONXChartOptionService'];
    
	function ICONXCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
