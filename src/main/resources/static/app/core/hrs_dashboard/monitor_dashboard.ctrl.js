(function () {
angular
    .module('mainMdl').controller('hrsCtrl', hrsCtrl);
	
hrsCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'hrsMainService', 'hrsChartOptionService'];
    
	function hrsCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("hrsCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
