(function () {
angular
    .module('mainMdl').controller('iconwebCtrl', iconwebCtrl);
	
iconwebCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'iconwebMainService', 'iconwebChartOptionService'];
    
	function iconwebCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("iconwebCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
