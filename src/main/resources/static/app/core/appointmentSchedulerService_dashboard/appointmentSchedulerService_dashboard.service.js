(function () {
    angular.module('mainMdl')
        .service('appointmentSchedulerServiceMainService', function ($http) {
           this.getTreeData = function(lastUpdatedData){
                return $http.get("/getLastHourDataForTree?dashboardName=AppointmentSchedulerService&lastUpdatedData="+lastUpdatedData)
