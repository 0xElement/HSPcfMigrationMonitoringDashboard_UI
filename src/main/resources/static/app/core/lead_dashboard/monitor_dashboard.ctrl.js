(function () {
angular
    .module('mainMdl').controller('leadCtrl', leadCtrl);
	
leadCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'leadMainService', 'leadChartOptionService'];
    
	function leadCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("leadCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
