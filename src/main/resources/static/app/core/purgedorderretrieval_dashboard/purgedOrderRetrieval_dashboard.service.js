(function () {
    angular.module('mainMdl')
        .service('purgedOrderRetrievalMainService', function ($http) {
           this.getTreeData = function(lastUpdatedData){
                return $http.get("/getLastHourDataForTree?dashboardName=PurgedOrderRetrieval&lastUpdatedData="+lastUpdatedData)
