(function () {
angular
    .module('mainMdl').controller('smhdemasterdataserviceCtrl', smhdemasterdataserviceCtrl);
	
smhdemasterdataserviceCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'smhdemasterdataserviceMainService', 'smhdemasterdataserviceChartOptionService'];
    
	function smhdemasterdataserviceCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("smhdemasterdataserviceCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
        ...
        function getData(lastUpdatedData) {
        	...
        	mainService.getTreeData(lastUpdatedData).then(function(response) {
                ...
                if(response.data.responseData && response.data.responseData.children.length > 0) {
            		...
            		appData.dashBoardName='Smhdemasterdataservice';
