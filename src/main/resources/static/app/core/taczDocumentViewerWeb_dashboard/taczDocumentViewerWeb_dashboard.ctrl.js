(function () {
angular
    .module('mainMdl').controller('taczDocumentViewerWebCtrl', taczDocumentViewerWebCtrl);
	
taczDocumentViewerWebCtrl.$inject = ['$scope', '$document','$interval', '$timeout', '$window', 'dialogs', 'taczDocumentViewerWebMainService', 'taczDocumentViewerWebChartOptionService'];
    
	function taczDocumentViewerWebCtrl($scope, $document, $interval, $timeout, $window, dialogs, mainService, chartOptionService) {
		console.log("taczDocumentViewerWebCtrl");
        var ctrl = this;
        ctrl.hourDonutData = [];
        ctrl.dayDonutData = [];
        ctrl.weekDonutData = [];
        ...
        function getData(lastUpdatedData) {
        	...
        	mainService.getTreeData(lastUpdatedData).then(function(response) {
                ...
                if(response.data.responseData && response.data.responseData.children.length > 0) {
            		...
            		appData.dashBoardName='TACZDocumentViewerWeb';
