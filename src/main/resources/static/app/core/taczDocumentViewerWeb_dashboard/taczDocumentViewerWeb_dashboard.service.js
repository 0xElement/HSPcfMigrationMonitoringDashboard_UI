(function () {
    angular.module('mainMdl')
        .service('taczDocumentViewerWebMainService', function ($http) {
           this.getTreeData = function(lastUpdatedData){
                return $http.get("/getLastHourDataForTree?dashboardName=TACZDocumentViewerWeb&lastUpdatedData="+lastUpdatedData)
